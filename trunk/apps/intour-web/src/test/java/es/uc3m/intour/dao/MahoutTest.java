...
public class MahoutTest {
	...
	public static void main(String[] args) {
		...
		MahoutPOIDAOImpl mahout = new MahoutPOIDAOImpl();
		...
		mahout.saveScores(pois, "3");
		List<POI> poisRecommended = mahout.recommendRoute(pois);
		
		for(int i=0; i<poisRecommended.size(); i++){
			System.out.println("LatRecomend: "+poisRecommended.get(i).getLat()+" LngRecomend: "+poisRecommended.get(i).getLon());
		}
